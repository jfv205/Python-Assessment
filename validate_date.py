...
def validate_date(date):
    ...
    # Remove spaces in string if present.
    if " " in date:
        date = date.replace(" ", "")
        
    # Remove hyphens in string if present.
    if "-" in date:
        date = date.replace("-", "")
...
def test_valid():
    ...
    print("The given date string should only contains numbers, spaces or hyphen characters.")
